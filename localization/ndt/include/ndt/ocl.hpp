...
//
// The NormalDistributionsTransformOCL class is based
...
#ifndef NORMAL_DISTRIBUTIONS_TRANSFORM_OCL_H
#define NORMAL_DISTRIBUTIONS_TRANSFORM_OCL_H
...
class NormalDistributionsTransformOCL
: public NormalDistributionsTransformBase<PointSource, PointTarget>
{
public:
  NormalDistributionsTransformOCL();
  ~NormalDistributionsTransformOCL() = default;
  ...
  void setNeighborhoodSearchMethod(pclocl::NeighborSearchMethod method);

  int getNumThreads() const;
  pclocl::NeighborSearchMethod getNeighborhoodSearchMethod() const;

private:
  boost::shared_ptr<pclocl::NormalDistributionsTransform<PointSource, PointTarget>> ndt_ptr_;
};
